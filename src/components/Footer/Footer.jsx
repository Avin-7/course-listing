...
export const Footer = () => {
  return (
    <div className='bg-gray-950 mx-auto sm:p-10 flex flex-col items-center justify-center gap-4 '>
        ...
        <div className='socialIcons flex items-center justify-evenly gap-6 '>
            ...
            <a href="#" className='bg-white p-2 rounded-full hover:bg-purple-600'> <FaInstagram size={25}/></a>
            <a href="#" className='bg-white p-2 rounded-full hover:bg-purple-600'><FaSquareTwitter size={25}/></a>
            <a href="#" className='bg-white p-2 rounded-full hover:bg-purple-600'><FaLinkedin size={25}/></a>
        </div>
        {/* ******Routes wrapper****** */}
