  ...
  return (
    <div className=" p-11 w-full h-screen flex  sm:p-12 bg-cyan-100/70 ">
      <div className=" hidden sm:block w-1/2  p-20">
        <div>
          <h1 className="font-roboto text-3xl font-bold text mb-4">
            {course.name}
          </h1>
        </div>
        <div>
        ...
        <div>
          ...
          <div>
            <p>
              Course by <span className="text-purple-500">{course.author}</span>
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="mt-5">
            <h1 className="font-roboto text-slate-900 text-2xl font-bold">
      ...
      <div className=" w-full sm:w-1/2 p-20 flex items-start justify-center">
        <div className="bg-gray-50 h-auto w-auto shadow-xl">
          ...
          <div className="sm:hidden ml-3 mt-3 text-lg font-roboto font-bold">
            <h1>{course.name}</h1>
          </div>
          ...
          <div className="flex flex-row w-full p-3">
            <div className="flex items-center  justify-center mr-5 ">
              <FaRegStar fill="gold" size={16} />
              <p className="ml-1">{course.ratings}</p>
            </div>
            <div className="flex items-center justify-center mr-5">
              <LuClock size={15} />{" "}
            ...
            <div className="flex items-center justify-center mr-5 ">
              <PiGlobeBold />
              <p className="ml-2 font-roboto">English</p>
            </div>
          </div>
          ...
          <div>
            {" "}
            <p className="font-roboto ml-3 mb-3">
